...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(num1 > num2 && num1 > num3) { return "Número 1 es mayor y positivo";
     ...
     //}else if(num1 != num1 ||num2 != num2 ||num3 != num3 ) {return "Hay negativos";
     }else return false; 
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
   //var tabla =tablaDelSeis(tabla);
   let arrai = [];
 //for (let i = 0; i < 11; i++) {
   //  return (i * Arrai[tabla]);
// } 
   for (let i = 0; i <= 10; i++) {
    let tabla = 6 * i;
    arrai.push(tabla);
...
function tieneTresDigitos(numero){
  ...
  //for (let i = 0; i == digito.length; i++ ) {
    //if (digito[i].length === 3) return true;
        //for (i=0; i = numero.length;i++);
    //}
    //if (mumero != 3) return true;{
     // return false;
    //}
if (numero > 99 && numero < 1000) return true;
else return false;
//no siemprer es con for
}
